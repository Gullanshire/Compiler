...
public class RunTime {
	...
	public static final String CHAR_PRINT_FORMAT      = "$print-format-character";
	...
	public static final String INTEGER_DIVIDE_BY_ZERO_RUNTIME_ERROR = "$$int-divide-by-zero";
	public static final String FLOAT_DIVIDE_BY_ZERO_RUNTIME_ERROR = "$$float-divide-by-zero";
